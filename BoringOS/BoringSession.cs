...
{
    public BoringSession(ITerminal terminal, SystemInformation systemInformation, Stopwatch sysTimer, IBoringKernel kernel)
    {
    ...
    public readonly IBoringKernel Kernel;
